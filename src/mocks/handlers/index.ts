...
const adminLogin: HttpResponseResolver = async ({ request }) => {
  ...
  return HttpResponse.json<API.ResponseStructure<LoginResponse>>({
    success: true,
    msg: "成功",
    data: {
...
const getUserInfo: HttpResponseResolver = async () => {
  return HttpResponse.json<API.ResponseStructure<InfoResponse>>({
      "data": {
          "access": [
              "dashboard",
              "dashboard.analysis",
...
const getRules: HttpResponseResolver = async () => {
  return HttpResponse.json<API.ResponseStructure<ISysRule[]>>({
    success: true,
    msg: "成功",
    data: defaultRoute
  })
